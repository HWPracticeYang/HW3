<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="food.aspx.cs" Inherits="WebApplication2.food" MaintainScrollPositionOnPostback="true"%>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center" BackColor="#A6B1E1">
                <asp:Label ID="aaa" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="White" Text="飲食問卷"></asp:Label>
                <br />
