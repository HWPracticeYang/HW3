<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sleep.aspx.cs" Inherits="WebApplication2.sleep" MaintainScrollPositionOnPostback="true"%>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center" BackColor="#A6B1E1">
                <asp:Label ID="aaa" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="White" Text="睡眠問卷"></asp:Label>
                <br />
                <asp:Panel ID="Panel2" runat="server" HorizontalAlign="Left" style="margin-left: 535px" Width="300px" CssClass="a">
                </asp:Panel>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
