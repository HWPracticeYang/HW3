...
namespace WebApplication2
{
    public partial class sleep : System.Web.UI.Page
    {
        ...
        RadioButtonList[] rbl = new RadioButtonList[8];
        String name = "睡眠";
        int qid = 0;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            //SqlDataAdapter da1 = new SqlDataAdapter("Select * From question where name='睡眠'", conn);
            //DataSet ds = new DataSet();

            //da1.Fill(ds, "question");
            //DataTable dt1 = ds.Tables["question"];
            //qid = int.Parse(dt1.Rows[0]["Qid"].ToString());

            //SqlDataAdapter da2 = new SqlDataAdapter("Select * From [question_list] where Qid='" + qid + "'", conn);
            //da2.Fill(ds, "question_list");
            //DataTable dt2 = ds.Tables["question_list"];
